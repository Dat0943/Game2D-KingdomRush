...
//		Debug.Log("delay:"+delay+" progress:"+this.current.progress+" this.current.totalDelay:"+this.current.totalDelay);
...
//			Debug.Log("seq.progress:" + progress + " seq.tween:" + seq.tween);
